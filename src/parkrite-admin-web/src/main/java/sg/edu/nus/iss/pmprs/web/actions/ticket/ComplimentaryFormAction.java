...
@Action(
		value="createcomplimentaryform", 
	    	results={@Result(name="success", location="/content/ticket/Complimentary.jsp")}
		)

public class ComplimentaryFormAction extends CommonAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6396075574727590164L;

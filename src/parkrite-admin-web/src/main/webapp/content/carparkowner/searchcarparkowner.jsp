...
<body>
<s:form class="form-horizontal" action="searchcarparkownerform" >
	<s:select label="Search By"
       name="searchBy"
       headerValue="Select One"
       list="#{'01':'Parkrite Merchant ID', '02':'Company Name', '03': 'CPO Name'}"
       required="true"/>
  ...
  <display:column property="parkritemerchantid" title="Parkite Merchant ID" sortable="false"   />

...
<title>Maintain Car Park Owner</title>
<!-- 
<s:if test="type=='maintain'">
<title>Maintain Car Park Owner</title>
</s:if>
...
<body>
	...
	<s:form class="form-horizontal" action="maintaincarparkowner" >
 	...
 	<table class="carparkform-table">
		...
		<table class="carparkform-col1">
			...
			<s:hidden name="model.carparkownerid"></s:hidden>
			...
			<s:textarea name="model.remark" label="Remark" class="carparform-textarea"/>
	   		...
	   		<table>
				<tr><td >
	   				<table><s:submit action="maintaincarparkowner"/></table>
	   			</td><td>
	   		
	   		
	   		<table>
	   		 <s:submit value="Delete" action="deletecarparkowner"/></table>

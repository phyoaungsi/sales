...
<title>Complimentary Ticket</title>
	<script>
...
<body>
	...
	<s:form class="form-horizontal" action="complimentaryaction" >
 	...
 	<table class="carparkform-table">
		...
		<table class="carparkform-col1">
			...
			<s:select label="Complimentary Reason" name="model.reasonId" 
			...
			<tr><td >
					<table><s:submit value="Give Complimentry Ticket" name="givecomplimentary"/></table>
	   		</td><td>

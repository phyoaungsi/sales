...
<s:include value="javascript_header.jsp" />
  ...
  <!-- Bootstrap core CSS -->
    ...
    <!-- Icons -->
    <link href="<s:url value="/css/admin4/font-awesome.css"/>" rel="stylesheet">
	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item"><s:a namespace="/dashboard" action="dashboard">Dashboard </s:a></li>
					

		
			<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Orders</a>
						<ul class="dropdown-menu">
							<li><s:a cssClass="nav-link" namespace="/order" action="createOrderForm">Create Order</s:a></li>
							<li><s:a cssClass="nav-link" namespace="/carparkowner" action="searchcarparkownerform">Update Order</s:a></li>
			...
			<s:a cssClass="logout-button" namespace="/logout"
							action="logout"><em class="fa fa-power-off"></em>Logout</s:a></nav>
				...
				<header class="page-header row justify-center">
					...
					<div class="dropdown user-dropdown col-md-6 col-lg-4 text-center text-md-right"><a class="btn btn-stripped dropdown-toggle" href="https://example.com" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<div class="username mt-1">
							<h4 class="mb-1"><s:property value="loginUserId"/></h4>
							
							<h6 class="text-muted"><s:property value="access"/></h6>
						</div>
						</a>
...
<div class="card-block">
										<h3 class="card-title"><decorator:title></decorator:title></h3>
...
<s:if test="hasActionErrors()">
    ...
    <script src="<s:url value="/js/tether.min.js"/>" integrity="sha384-DztdAPBWPRXSA/3eYEEUWrWCy7G5KFbe8fFjk5JAIxUYHKkDx6Qin1DkWx51bBrb" crossorigin="anonymous"></script>

...
<s:include value="javascript_header.jsp" />
  ...
  <!-- Bootstrap core CSS -->
    ...
    <!-- Icons -->
    <link href="<s:url value="/css/font-awesome.css"/>" rel="stylesheet">
...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">WitchyBoutique 
					System - <s:property value="loginUserId"/></a>
					<s:property value="access"/>
			</div>

			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><s:a namespace="/dashboard" action="dashboard">Dashboard </s:a></li>
					

					<!-- 
						<li><s:a namespace="/user" action="createUserForm">User Access</s:a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Car Park Owner <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="../carparkowner/carparkowner.do">Create CPO</a></li>
							<li><a href="#">Maintain CPO</a></li>

							<li class="divider"></li>
							<li><a href="#">Maintain Car Park</a></li>
							<li class="divider"></li>
							<li><a href="#">Search CPO</a></li>
						</ul></li>
					 


					<li class=""><s:a namespace="/carparkowner"
							action="createcarparkownerform">Car Park Owner</s:a></li>

	
					<li class=""><s:a namespace="/member"
							action="createMemberForm">Member </s:a></li>
		-->
		
			<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Orders</a>
						<ul class="dropdown-menu">
							<li><s:a namespace="/order" action="createOrderForm">Create Order</s:a></li>
							<li><s:a namespace="/carparkowner" action="searchcarparkownerform">Update Order</s:a></li>
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">User Access</a>
						<ul class="dropdown-menu">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Car Park Owner</a>
						<ul class="dropdown-menu">
							<li><s:a namespace="/carparkowner" action="createcarparkownerform">Create CPO</s:a></li>
							<li><s:a namespace="/carparkowner" action="searchcarparkownerform">Maintain CPO</s:a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Ticket</a>
						<ul class="dropdown-menu">
							<li><s:a namespace="/ticket" action="createcomplimentaryform">Complimentary</s:a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><s:a namespace="/reports/download" action="carparkOwnerReport">Car Park Owner Report</s:a></li>
							<li><s:a namespace="/reports/download" action="memberReport">Member Report</s:a></li>
							<li><s:a namespace="/reports/download" action="bookingReport">Booking Report</s:a></li>
							<li><s:a namespace="/reports/download" action="redemptionReport">Redemption Report</s:a></li>
							<li><s:a namespace="/reports/download" action="complimentaryReport">Complimentary Report</s:a></li>
						</ul></li>
						
						
					<li><s:a namespace="/logout"
							action="logout">Logout</s:a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar jumbotron">
...
<div class="container-fluid" id="wrapper">
			...
			<main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
				...
				<section class="row">
					<div class="col-sm-12">
						...
						<section class="row">
							<div class="col-12 mt-1 mb-4"></a></div>
						</section>
					</div>
				</section>
			</main>
    ...
    <script src="<s:url value="/js/tether.min.js"/>"></script>
